...
// Use this to not show html output. Good for improving speed of build (running all tests) locally
// As we dont need to see the html. but should have off when running in CI show tests output can be seen be whoever
// This can be set as env variable in pom (WIP)
// working when doing in terminal:  mvn -Dtest=endtoendtests.other.OptionalYatspecOutputExampleTest -Dskip.yatspec.output=true  test
@RunWith(OptionalYatspecRunner.class)
public class OptionalYatspecOutputExampleTest extends TestState implements WithCustomResultListeners {
