...
// Used for creating sequence diagram, so it can link up the the captured inputs and outputs together
// Thus creating a linked sequence diagram
public class ByCustomNamingConventionMessageProducer {
